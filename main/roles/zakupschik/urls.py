...
urlpatterns = [
    ...
    re_path(r'locations/(?P<location>[/\w]+)/(?P<floor>[/\w]+)/(?P<line>[/\w]+)/$', views.ZakupschikPlacesView.as_view(), name='zakupschik_places'),
    re_path(r'locations/(?P<location>[/\w]+)/(?P<floor>[/\w]+)/$', views.ZakupschikLocationsLinesView.as_view(), name='zakupschik_locations_lines'),
    re_path(r'locations/(?P<location>[/\w]+)/$', views.ZakupschikLocationsFloorsView.as_view(), name='zakupschik_locations_floors'),
